...
namespace VisualSVN_Agent.utils
{
    class EncryptsAndDecryptsHelper
    {
        ...
        public static string Encrypt(string text,string SecretKey,string AccessKey)
        {
            ...
            aes.IV = Encoding.UTF8.GetBytes(AccessKey);
        ...
        public static string Decrypt(string encrypted,string SecretKey, string AccessKey)
        {
